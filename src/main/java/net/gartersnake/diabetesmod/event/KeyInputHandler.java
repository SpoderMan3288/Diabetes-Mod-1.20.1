...
public class KeyInputHandler {
    public static final String KEY_CATEGORY_DIABETES = "key.category.diabetesmod.diabetes";

    public static final String KEY_INCREASE_GLUCOSE = "key.diabetesmod.increase_glucose";
    public static final String KEY_DECREASE_GLUCOSE = "key.diabetesmod.decrease_glucose";
