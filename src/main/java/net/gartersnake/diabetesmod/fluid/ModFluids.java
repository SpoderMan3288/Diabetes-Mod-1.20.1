package net.gartersnake.diabetesmod.fluid;

import net.fabricmc.fabric.api.item.v1.FabricItemSettings;
import net.fabricmc.fabric.api.object.builder.v1.block.FabricBlockSettings;
import net.gartersnake.diabetesmod.DiabetesMod;
import net.gartersnake.diabetesmod.fluid.custom.InsulinFluid;
...
public class ModFluids {
    ...
    public static void register() {
        STILL_INSULIN = Registry.register(Registries.FLUID,
                new Identifier(DiabetesMod.MOD_ID, "insulin"), new InsulinFluid.Still());

        FLOWING_INSULIN = Registry.register(Registries.FLUID,
                new Identifier(DiabetesMod.MOD_ID, "flowing_insulin"), new InsulinFluid.Flowing());

        INSULIN_BLOCK = Registry.register(Registries.BLOCK,
                new Identifier(DiabetesMod.MOD_ID, "insulin_block"),
        ...
        INSULIN_BUCKET = Registry.register(Registries.ITEM,
                new Identifier(DiabetesMod.MOD_ID, "insulin_bucket"),
